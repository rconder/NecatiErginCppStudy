...
namespace nec_ornek_6{
    ...
    void ornek_6()//main'de cagir!!!
    {
        std::cout<<"ornek 6 Main\n;"
        //Owner x; //SENTAKS HATASI Delet edilmiş bir fonksiyona çağrı yapıldı hatası alırdık
    }
}
    ...
    public:
        ...
        Yukardaki yerine
            Student(const char* pname, const char* psurname)
            {
                ...
                veri elemanları init list ile init etmeye çalış
            }
...
namespace nec_ornek_10{
    ...
    /* Yorum_no:
        ...
        öbür türlü class'ta kullanılan member'ın    
    */
}
