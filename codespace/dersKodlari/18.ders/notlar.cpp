...
int x = 5; bu sentaks hatası 
using ile ali::x enjektesi scope'a enjekte edilmiş oluyor.
...
{
    veli::x = 10;
    //veli::ali sentaks hatası
}
//========
int g = 10;
namespace nec1{
    using ::x; //global namespace içindeki g
}
