...
- [11.Hafta](#11hafta)
  ...
  - [C++20 Gelen Yeni Özellikler](#c20-gelen-yeni-özellikler)
    ...
    - [Using Enum bildirimi](#using-enum-bildirimi)
...
- Bir çok yerde artık kullanılabiliyor, örneğin fonksiyonun geri dönüş değeri olarak kullanılabilir.

### Using Enum bildirimi

- Bir enum türü:
- - Eski enum türlerinden tam sayı türlerine dönüşüm yapılabilirdi.
- - Enumaration constant isimler ayrı bir scope içerisinde değildi ve bu isim çakışması türünden problem oluşturabilirdi.
- - Bir class değil!
- - scoped enum olarak tanımlanabilir. Böylece kendi scope türü oluyor ve çözünürlük operatörleri ile kullanılabiliyor.
